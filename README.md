...
> **Note:** This project requires the `--legacy-peer-deps` flag due to peer dependency conflicts between React 19 and some packages. This is normal and won't affect functionality.
